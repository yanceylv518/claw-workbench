...
$versionConfig = Get-Content -Raw -Encoding UTF8 (Join-Path $root "VERSION.json") | ConvertFrom-Json
$productVersion = $versionConfig.version
$productNameZh = [string]::Concat([char]0x5C0F, [char]0x9F99, [char]0x867E, [char]0x5DE5, [char]0x4F5C, [char]0x53F0)
